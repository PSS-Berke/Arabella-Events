export const metadata = {
  title: "PACKAGES | Arabella's Weddings & Events | AWE",
  alternates: { canonical: '/services' },
  openGraph: { url: '/services', siteName: "Arabella's Weddings & Events | AWE ", type: 'website' },
};

// Live renders two Wix video players between the Full and Partial sections;
...
export default function Packages() {
  return (
    <main className="mx-auto max-w-[1000px] px-6 pb-8 pt-12 text-[#443221] md:px-10 md:pb-10 md:pt-[70px]">
      <section className="pb-[78px] text-center">
        <div className="font-script text-[38px] leading-none sm:text-[44px] md:text-[62px]">Full</div>
        <h1 className="mb-[34px] mt-1.5 font-display text-[22px] font-light tracking-[0.13em] sm:text-[27px] md:text-[38px] md:tracking-[0.19em]">PLANNING + DESIGN</h1>
        <p className="mx-auto max-w-[760px] text-[13px] font-light uppercase leading-[2.1] tracking-[0.08em] text-pretty md:tracking-[0.14em]">
      ...
      {/* Two video players between the Full and Partial sections, as on live */}
      <section className="flex flex-col items-center gap-[42px] pt-[10px]">
        <VideoBlock
          ...
          autoplay
          loop={false}
          className="aspect-[404/311] w-full max-w-[404px]"
        />
        <VideoBlock
          ...
          autoplay={false}
          loop={false}
          className="aspect-[390/355] w-full max-w-[390px]"
        />
      </section>
      ...
      <section className="py-[78px] text-center">
        ...
        <ul className="mx-auto flex max-w-[620px] list-none flex-col gap-[14px] p-0 text-left text-[14.5px] font-light tracking-[0.05em]">
